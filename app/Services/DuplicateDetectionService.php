...
{
    public static function findDuplicates(string $description, int $institutionId, int $excludeId = 0): array
    {
        ...
        $recentIssues = Grievance::where('institution_id', $institutionId)
            ->where('id', '!=', $excludeId)
